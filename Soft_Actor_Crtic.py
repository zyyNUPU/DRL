...
class SAC:
    ...
    def calc_target(self, rewards, next_states, dones):
        ...
        next_value = min_qvalue + self.log_alpha.exp() * entropy  # 这个是V-soft
    ...
    def update(self, transition_dict):
        ...
        td_target = self.calc_target(rewards, next_states, dones) # 得到TD_target
        ...
        # 更新可训练遍历alpha
        # --------------------------------- #
        #当策略的实际熵大于目标熵-1时，alpha_loss会趋向正值，这会推动alpha增大，使得策略熵减少，从而减少随机性。
        #当策略的实际熵小于目标熵-1时，alpha_loss会趋向负值，这会推动alpha减小，使得策略熵增加，从而增加随机性。
